          ...
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-gray-200 flex flex-col relative overflow-hidden">
                ...
                <p class="flex items-center text-gray-200 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-800 text-gray-200 rounded-full flex-shrink-0">
                    <svg
                      fill="none"
                      stroke="currentColor"
                      stroke-linecap="round"
                ...
                <button class=" button flex items-center mt-auto  text-gray-900 fs-5  py-2 px-4 w-full  ">
                  Read More
                </button>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-gray-200 flex flex-col relative overflow-hidden">
                <h1 class="text-4xl text-white pb-4 mb-4 border-b border-gray-800 leading-none">
                  chiropractor
                </h1>
                <p class="flex items-center text-gray-200 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-800 text-gray-500 rounded-full flex-shrink-0">
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-gray-200 flex flex-col relative overflow-hidden">
                <h1 class="text-3xl text-white leading-none flex items-center pb-4 mb-4 border-b border-gray-800">
                  skin specialist
                </h1>
                <p class="flex items-center text-gray-200 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-800 text-gray-500 rounded-full flex-shrink-0">
